...
function Login() {
  ...
  useEffect(() => {
    ...
    if (oauthError) {
      setError(oauthError === 'oauth_failed' ? 'Google login failed. Please try again.' : 'Authentication error');
    } else if (token) {
    ...
    <div className="login-container">
      <div className="login-card">
        ...
        <p className="subtitle">
          {isLogin 
            ? 'Enter your credentials to access SIZA' 
            : 'Create an account to start generating reels'}
        </p>
